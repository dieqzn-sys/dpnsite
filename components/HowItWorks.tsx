    ...
    <section id="how-it-works" className="section-space relative overflow-hidden">
      ...
      <div className="container-shell">
        <SectionHeading
          ...
          description="Сначала выберите подходящие условия, затем оформите доступ и подключите устройства по инструкции."
          align="center"
        />

        <ol className="relative mt-14 grid gap-8 md:grid-cols-3 md:gap-5">
          <span className="absolute left-[16.67%] right-[16.67%] top-7 hidden h-px bg-gradient-to-r from-violet-500/20 via-cyan-300/70 to-blue-500/20 md:block" aria-hidden="true" />
